	...
	public void onFoodEaten(FoodEvent.FoodEaten event) {
		...
		if (storedHP < event.player.getMaxHealth()) 
		{
			...
			if(event.player.world.isRemote) 
			{
				...
				TextComponentTranslation milestoneMessage = new TextComponentTranslation("What a unique flavor! You've gained " +(hpm==1?"a heart!":hpm + " hearts!"));
				...
				{
					milestoneMessage = new TextComponentTranslation("Your desire to seek unique foods is finally satisfied.");
				}
				else
				{
